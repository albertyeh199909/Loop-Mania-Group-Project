...
public class LoopManiaWorld {
    ...
    public SimpleBooleanProperty standardMode;
    public SimpleBooleanProperty survivalMode;
    public SimpleBooleanProperty berserkerMode;
    public SimpleBooleanProperty confusingMode;
